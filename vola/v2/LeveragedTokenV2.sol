...
contract LeveragedTokenV2 is ERC20PermitUpgradeable, AccessControlUpgradeable, IVolaLeveragedTokenV2 {
  /**********
   * Events *
   **********/
  ...
  /// @inheritdoc IVolaLeveragedTokenV2
  function nav() external view override returns (uint256) {
    uint256 _xSupply = totalSupply();
    if (IVolaTreasuryV2(treasury).isUnderCollateral()) {
      return 0;
    } else if (_xSupply == 0) {
      return PRECISION;
    } else {
