...
contract RebalancePoolRegistry is Ownable2Step, IVolaRebalancePoolRegistry {
  ...
  /// @inheritdoc IVolaRebalancePoolRegistry
  ...
  function totalSupply() external view override returns (uint256) {
    ...
    for (uint256 i = 0; i < _length; i++) {
      ...
      _totalSupply += IVolaRebalancePool(_pool).totalSupply();
    }
    return _totalSupply;
  }
